  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <div class="header-actions">
        ...
        <button class="btn btn-primary" id="Sign-In"><a href="./Register/login.php" style="color: white;">Sign in</a></button>
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="#top-rated" class="navbar-link">Movie</a>
          </li>
          ...
          <li>
            <a href="#tv-series" class="navbar-link">Web Series</a>
          </li>

          <li>
            <a href="./Subscribe/index.html" class="navbar-link">Pricing</a>
          </li>
  ...
  <footer class="footer">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2023 <a href="#">Filmlane</a>. All Rights Reserved
        </p>
